...
A project on visualizing the effect of optimization on trained small neural networks. We use representational similarity measures to compare the representations of layers. The gifs below are the similarity between layers of a neural network at training time versus its final state:
